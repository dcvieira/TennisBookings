...
namespace TennisBookings.Merchandise.Api.IntegrationTests.Controllers
{
    public class ProductsControllerTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        ...
        [Fact]
        public async Task GetAll_ReturnsExpectedProduct()
        {
        ...
        public async Task Post_WithInvalidName_ReturnsExpectedProblemDetails(TestProductInputModel productInputModel, Action<KeyValuePair<string, string[]>> validator)
        {
        ...
        [Fact]
        public async Task Post_WithExistingProductId_ReturnConflict_WithExpectedLocation()
        {
